...
color_pickr <- function(n, palette = "Jalama") {
  ...
  if (palette == "Jalama") {
    ...
    if (n == 4 ) {p = c("#006175", "#DB504A", "#E3B505", "#A9CBB7")}
    if (n == 5 ) {p = c("#006175", "#EFECCA", "#DB504A", "#A3BCF9", "#E3B505")}
    if (n == 6 ) {p = c("#006175", "#EFECCA", "#DB504A", "#A3BCF9", "#E3B505", "#A9CBB7")}
    if (n == 7 ) {p = c("#006175", "#EFECCA", "#DB504A", "#A3BCF9", "#E3B505", "#A9CBB7", "#7D6D61")}
    if (n == 8 ) {p = c("#006175", "#EFECCA", "#DB504A", "#A3BCF9", "#E3B505", "#A9CBB7", "#7D6D61", "#157145")}
    if (n == 9 ) {p = c("#006175", "#EFECCA", "#DB504A", "#A3BCF9", "#E3B505", "#A9CBB7", "#7D6D61", "#157145",  "#AA78A6")}
